...
Ce dépôt a était crée pour but de vous aider a créer des templates sur proxmox pour ensuite utiliser l'outil cloud-init pour pouvoir configurer vos VM comme bon vous semble.
...
~~~bash 
 ...
 # Commande à exécuter après le déploiement de la machine virtuelle
    command = "sleep 1m && ANSIBLE_HOST_KEY_CHECKING=False ansible-playbook -i '172.16.99.${count.index + 2},' -u root   /home/anto/automatisation/ansible/setup_vm.yml"
